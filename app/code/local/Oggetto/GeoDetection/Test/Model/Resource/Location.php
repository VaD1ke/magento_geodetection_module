...
/**
 * Location resource model test class
 *
 * @category   Oggetto
 * @package    Oggetto_GeoDetection
 * @subpackage Test
 ...
 */
class Oggetto_GeoDetection_Test_Model_Resource_Location extends EcomDev_PHPUnit_Test_Case
{
    /**
     * Location resource model
     *
     * @var Oggetto_GeoDetection_Model_Resource_Location
     */
    ...
    {
        parent::setUp();
        $this->_resourceModel = Mage::getResourceModel('oggetto_geodetection/location');
    }
    ...
    {
        $this->assertEquals('oggetto_geodetection_iplocations', $this->_resourceModel->getMainTable());
