 ...
 */
class Oggetto_GeoDetection_Test_Model_Location_Relation extends EcomDev_PHPUnit_Test_Case
{
    /**
     * Model location relation
     *
     * @var Oggetto_GeoDetection_Model_Location_Relation
     */
    ...
    {
        parent::setUp();
        $this->_model = Mage::getModel('oggetto_geodetection/location_relation');
    }
    ...
    {
        $this->assertEquals('oggetto_geodetection/location_relation', $this->_model->getResourceName());
    }
    ...
    public function testDeletesRegionsByCountryCodeFromCollection()
    {
        ...
        $modelRelationMock->setData($region);
